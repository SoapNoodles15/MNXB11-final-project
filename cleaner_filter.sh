...
grep '\-04\-26,0[6-7]:00:00' $PROJECT_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY26APRIL
...
awk -F',' '{
 ...
 grep -E '\-(12|01)\-(0[1-9]|[12][0-9]|3[01]),0[6-7]:00:00' $PROJECT_BAREDATAFILENAME > $FILTER_FILTERNAME_WINTER