...
# Source files
SRCS := src/coldwarm.cxx main.cxx  src/winter3.cxx# main.cxx is in the root directory
OBJS := src/coldwarm.o src/main.o    src/winter3.o# Define object files explicitly
